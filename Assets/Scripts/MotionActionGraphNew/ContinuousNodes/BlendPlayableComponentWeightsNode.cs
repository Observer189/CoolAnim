...
namespace CoolAnimation
{
    ...
    public class BlendPlayableComponentWeightsNode : MotionActionNodeNew
    {
        ...
        {
            return new BlendPlayableComponentWeightsExecutableNew(_targetWeights, _duration, _curve);
        }
    }
    
    public class BlendPlayableComponentWeightsExecutableNew : MotionContinuousActionNodeExecutableNew
    {
        ...
        public BlendPlayableComponentWeightsExecutableNew(BlendPlayableComponentDataNew[] targetWeights, 
