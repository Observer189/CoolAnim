...
namespace CoolAnimation
{
    ...
    public class PlayMotionContinuousNodeNew : MotionActionNodeNew
    {
        ...
        {
            return new PlayMotionContinuousNodeExecutableNew(_motionClip, _duration, _setDurationBasedOnClip);
        }
    }
    
    public class PlayMotionContinuousNodeExecutableNew : MotionContinuousActionNodeExecutableNew
    {
        private AnimationClip _motionClip;
        private float _duration;
        private bool _setDurationBasedOnClip;

        public PlayMotionContinuousNodeExecutableNew(AnimationClip clip, float duration, bool setDurationBasedOnClip)
        {
            _motionClip = clip;
            _duration = duration;
